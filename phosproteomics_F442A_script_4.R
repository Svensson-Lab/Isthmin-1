...
pp_norm <- readRDS(file="pp_norm.rds")
...
# finding genes associated with the GO term: insulin receptor signaling pathway
mTOR_pathway_genes <- get_anno_genes("GO:0038201", database = 'Mus.musculus')
...
goterms <- Term(GOTERM)
saveRDS(goterms,"2022_05_16_GOterms.rds")
...
ggsave(file=paste0("plots/",paste0("is_peptide_shared_venn_0NA",".svg")),
       width=8, height=6)
...
ggsave(file=paste0("plots/",paste0("TOR_complex_shared_venn_0NA",".svg")),
       width=8, height=6)
...
ggsave(file=paste0("plots/",paste0("muscle_peptide_shared_venn_0NA",".svg")),
       width=8, height=6)
...
write.table(p_found,file=paste0("tables/",
  paste0("phosphopeptide_goterm_found",".tsv")),sep="\t")
rm(p_found)

# Listing and saving specific muscle genes in dataset also in muscle related
# go terms
goterms <- Term(GOTERM)
#View(goterms[grep("muscle",goterms)])
muscle_pathways_genes <- get_anno_genes(names(goterms[grep("muscle",goterms)]), 
                                        database = 'Mus.musculus')
muscle_genes <- gsub(";\\S+","",
...
write.table(muscle_genes,file=paste0("tables/",
  paste0("phosphopeptide_muscle_goterm_found",".tsv")),sep="\t")
...
circos.genomicTrackPlotRegion(bed2,ylim = c(0, 1),
                              panel.fun = function(region, value, ...) {
                                circos.genomicText(region, value, y = 9.5, labels.column = 1,
                                                   facing = "clockwise", adj = c(0, 0),
                                                   cex = 0.71,niceFacing = TRUE, # Previous cex=0.7
                                                   posTransform = posTransform.text,
                                                   padding=-0.17, # Previous padding 0.2
...
dev.copy2pdf(file=paste0("plots/circular_plot_0NA",paste0(".pdf")), width=16, height=16)
dev.off()
svg("C:/Postdoc Stanford/Projects/Isthmin phoshoproteomics/plots/2022-03-04_circular.svg")
...
ggplot(Insr, aes(x=condition,y=Insr,fill=condition,width=.8)) + 
  ...
  theme(axis.title.x=element_blank(),
                     axis.text.x = element_text(angle = 45, 
                                                vjust = 1, hjust=1))
ggsave(paste0("plots/",paste0("Insr_bar_percentmax",".jpeg")),
       units="cm", width=8, height=10, dpi=600)
ggsave(file=paste0("plots/",paste0("Insr_bar_percentmax",".svg")),
       width=8, height=10)
...
ggplot(Rps6ka5, aes(x=condition,y=Rps6ka5,fill=condition,width=.8)) + 
  ...
  theme(axis.title.x=element_blank(),
        axis.text.x = element_text(angle = 45, 
                                   vjust = 1, hjust=1))
ggsave(paste0("plots/",paste0("Rps6ka5_bar_percentmax",".jpeg")),
       units="cm", width=8, height=10, dpi=600)
ggsave(file=paste0("plots/",paste0("Rps6ka5_bar_percentmax",".svg")),
       width=8, height=10)
...
ggplot(Rps3a, aes(x=condition,y=Rps3a,fill=condition,width=.8)) + 
  ...
  theme(axis.title.x=element_blank(),
        axis.text.x = element_text(angle = 45, 
                                   vjust = 1, hjust=1))
ggsave(paste0("plots/",paste0("Rps3a_237_bar_percentmax",".jpeg")),
       units="cm", width=8, height=10, dpi=600)
ggsave(file=paste0("plots/",paste0("Rps3a_237_bar_percentmax",".svg")),
       width=8, height=10)
...
ggplot(Rps3a, aes(x=condition,y=Rps3a,fill=condition,width=.8)) + 
  ...
  theme(axis.title.x=element_blank(),
        axis.text.x = element_text(angle = 45, 
                                   vjust = 1, hjust=1))
ggsave(paste0("plots/",paste0("Rps3a_238_bar_percentmax",".jpeg")),
       units="cm", width=8, height=10, dpi=600)
ggsave(file=paste0("plots/",paste0("Rps3a_238_bar_percentmax",".svg")),
       width=8, height=10)
...
ggplot(Rpl13, aes(x=condition,y=Rpl13,fill=condition,width=.8)) + 
  ...
  theme(axis.title.x=element_blank(),
        axis.text.x = element_text(angle = 45, 
                                   vjust = 1, hjust=1))
ggsave(paste0("plots/",paste0("Rpl13_77_bar_percentmax",".jpeg")),
       units="cm", width=8, height=10, dpi=600)
ggsave(file=paste0("plots/",paste0("Rpl13_77_bar_percentmax",".svg")),
       width=8, height=10)
...
ggplot(Eif3a, aes(x=condition,y=Eif3a,fill=condition,width=.8)) + 
  ...
  theme(axis.title.x=element_blank(),
        axis.text.x = element_text(angle = 45, 
                                   vjust = 1, hjust=1))
ggsave(paste0("plots/",paste0("Eif3a_584_bar_percentmax",".jpeg")),
       units="cm", width=8, height=10, dpi=600)
ggsave(file=paste0("plots/",paste0("Eif3a_584_bar_percentmax",".svg")),
       width=8, height=10)
...
dev.copy2pdf(file=paste0("plots/irs_heatmap_grid_na",
                         paste0(".pdf")), width=7.2, height=4)
dev.off()
h
dev.copy2pdf(file=paste0("plots/irs_heatmap_nogrid_no_na",
                         paste0(".pdf")), width=7.2, height=4)
dev.off()
...
for(i in 1:(ncol(is_norm_intens)-1)){
  p <- ggplot(is_norm_intens, aes(x=condition,y=is_norm_intens[,i],fill=condition,width=.8)) + 
    ...
    theme(axis.title.x=element_blank(),
          axis.text.x = element_text(angle = 45, 
                                     vjust = 1, hjust=1))
  ggsave(p,file=paste0("plots/bargraphs/is/",paste0(paste0(colnames(is_norm_intens)[i]),"_bar_percentmax"),".jpeg"),
         units="cm", width=8, height=10, dpi=600)
  ggsave(p,file=paste0("plots/bargraphs/is/",paste0(paste0(colnames(is_norm_intens)[i]),"_bar_percentmax"),".svg"),
         width=8, height=10)
}
...
for(i in 1:(ncol(mu_norm_intens)-1)){
  p <- ggplot(mu_norm_intens, aes(x=condition,y=mu_norm_intens[,i],fill=condition,width=.8)) + 
    ...
    theme(axis.title.x=element_blank(),
          axis.text.x = element_text(angle = 45, 
                                     vjust = 1, hjust=1))
  ggsave(p,file=paste0("plots/bargraphs/mu/ism_vs_ins/",paste0(paste0(colnames(mu_norm_intens)[i]),"_bar_percentmax"),".jpeg"),
         units="cm", width=8, height=10, dpi=600)
  ggsave(p,file=paste0("plots/bargraphs/mu/ism_vs_ins/",paste0(paste0(colnames(mu_norm_intens)[i]),"_bar_percentmax"),".svg"),
         width=8, height=10)
}
...
for(i in 1:(ncol(mu_norm_intens)-1)){
  p <- ggplot(mu_norm_intens, aes(x=condition,y=mu_norm_intens[,i],fill=condition,width=.8)) + 
    ...
    theme(axis.title.x=element_blank(),
          axis.text.x = element_text(angle = 45, 
                                     vjust = 1, hjust=1))
  ggsave(p,file=paste0("plots/bargraphs/mu/ism_vs_bsa/",paste0(paste0(colnames(mu_norm_intens)[i]),"_bar_percentmax"),".jpeg"),
         units="cm", width=8, height=10, dpi=600)
  ggsave(p,file=paste0("plots/bargraphs/mu/ism_vs_bsa/",paste0(paste0(colnames(mu_norm_intens)[i]),"_bar_percentmax"),".svg"),
         width=8, height=10)
}
...
for(i in 1:(ncol(tor_norm_intens)-1)){
  p <- ggplot(tor_norm_intens, aes(x=condition,y=tor_norm_intens[,i],fill=condition,width=.8)) + 
    ...
    theme(axis.title.x=element_blank(),
          axis.text.x = element_text(angle = 45, 
                                     vjust = 1, hjust=1))
  ggsave(p,file=paste0("plots/bargraphs/tor/ism_vs_ins/",paste0(paste0(colnames(tor_norm_intens)[i]),"_bar_percentmax"),".jpeg"),
         units="cm", width=8, height=10, dpi=600)
  ggsave(p,file=paste0("plots/bargraphs/tor/ism_vs_ins/",paste0(paste0(colnames(tor_norm_intens)[i]),"_bar_percentmax"),".svg"),
         width=8, height=10)
}
...
for(i in 1:(ncol(tor_norm_intens)-1)){
  p <- ggplot(tor_norm_intens, aes(x=condition,y=tor_norm_intens[,i],fill=condition,width=.8)) + 
    ...
    theme(axis.title.x=element_blank(),
          axis.text.x = element_text(angle = 45, 
                                     vjust = 1, hjust=1))
  ggsave(p,file=paste0("plots/bargraphs/tor/ism_vs_bsa/",paste0(paste0(colnames(tor_norm_intens)[i]),"_bar_percentmax"),".jpeg"),
         units="cm", width=8, height=10, dpi=600)
  ggsave(p,file=paste0("plots/bargraphs/tor/ism_vs_bsa/",paste0(paste0(colnames(tor_norm_intens)[i]),"_bar_percentmax"),".svg"),
         width=8, height=10)
}
...
write.table(sig_table,row.names=FALSE,file=paste0("tables/",
  paste0("sig_ISMvsBSA",".tsv")),sep="\t") 
